...
# Input paths           
base_path = "C:/Users/gabro/Downloads" # <- folder you unziped the suplementary materials zip

area = 1

raw_dem_path =  f'{base_path}/Suplementary_Materials_Brochado_Renno_2024/Area_{area}/glo-30.tif'
water_mask_path = f'{base_path}/Suplementary_Materials_Brochado_Renno_2024/Area_{area}/glo-30_wbm.tif'
shapefile_path = f'{base_path}/Suplementary_Materials_Brochado_Renno_2024/Area_{area}/extent.gpkg'

# Output paths
output_path_final = f'{base_path}/Suplementary_Materials_Brochado_Renno_2024/Area_{area}/new_corrected_dem.tif'
aux_path = f'{base_path}/Suplementary_Materials_Brochado_Renno_2024/Area_{area}/aux'
